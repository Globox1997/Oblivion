                        ...
                        if (s == k || t == -1 || u == p || s == l || t == 4 || u == q) {
                            if (blockPos2x.getY() >= structureWorldAccess.getBottomY() && !structureWorldAccess.getBlockState(blockPos2x.down()).isSolid()) {
                                ...
                                if (t == -1 && random.nextInt(4) != 0) {
                                    this.setBlockStateIf(structureWorldAccess, blockPos2x, BlockInit.OBLIVION_MOSSY_COBBLED_STONE.getDefaultState(), predicate);
                                } else {
                                    this.setBlockStateIf(structureWorldAccess, blockPos2x, BlockInit.OBLIVION_COBBLED_STONE.getDefaultState(), predicate);
                                }
                            }
